...
\noindent An elite Drupal developer with a deep knowledge of open source software development, the education space, and collaborative software.
...
\begin{description}
  ...
  \item[\href{http://drupal.org/project/family_history}{Family History Distro}] Many families have 100s of documents and photos from their parents and grandparents they'd like to share. This project is to provide a Drupal distro to simplify the process of collecting and sharing stories, letters, documents, and pictures about your family, past and present.
\end{description}
...
\begin{description}
  ...
  \item[Programming languages] PHP, Python, Java, Bash, Javascript/CoffeeScript
\end{description}
